...
TRAINERS = {
    ...
    "fedntd": {"server": "FedNTDServer", "client": "FedNTDClient"},
    "fedsam": {"server": "FedSAMServer", "client": "FedSAMClient"},
    "fedadagrad": {"server": "FedAdagradServer", "client": "FedAvgClient"},
    "fedyogi": {"server": "FedYogiServer", "client": "FedAvgClient"},
    "fedadam": {"server": "FedAdamServer", "client": "FedAvgClient"},
    "fedfa": {"server": "FedFAServer", "client": "FedFAClient"},
    ...
    "fedmrl": {"server": "FedMRLServer", "client": "FedMRLClient"},
...
PARSER_ARGS = [
    ...
    },
    {
        "args": ["--adv_gain"],
        "kwargs": {
            "help": "scales the FedMRL advantage term when weighting alignment",
            "type": float,
            "default": 0.5,
        },
    },
